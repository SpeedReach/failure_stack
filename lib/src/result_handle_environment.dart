...
///}
///```
Result<NewReturnType,NewFailureType> resultHandleEnvironment<NewReturnType,NewFailureType>(
...
Future<Result<NewReturnType,NewFailureType>> asyncResultHandleEnvironment<NewReturnType,NewFailureType>  (
    Future<Result<NewReturnType,NewFailureType>> Function() process
    ) async {
  try {
